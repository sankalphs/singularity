...
- **`src/app/api/feedback`** — validates homepage feedback, stores it in SpacetimeDB, and sends a thank-you to the player through Resend without exposing the API key to the browser.
